...
depth.0TO100 <- readRDS("~/Notothenioids-Research/all_analysis_data_n_code/p9_csvAllLocations/SouthOrkneyIs/DDSOI1_pholomorpho+depthPlots/DDSOI.depth.0TO100_OUTPUTS.RData")
depth.101TO200 <- readRDS("~/Notothenioids-Research/all_analysis_data_n_code/p9_csvAllLocations/SouthOrkneyIs/DDSOI1_pholomorpho+depthPlots/DDSOI.depth.101TO200_OUTPUTS.RData")
depth.201TO300 <- readRDS("~/Notothenioids-Research/all_analysis_data_n_code/p9_csvAllLocations/SouthOrkneyIs/DDSOI1_pholomorpho+depthPlots/DDSOI.depth.201TO300_OUTPUTS.RData")
depth.301TO400 <- readRDS("~/Notothenioids-Research/all_analysis_data_n_code/p9_csvAllLocations/SouthOrkneyIs/DDSOI1_pholomorpho+depthPlots/DDSOI.depth.301TO400_OUTPUTS.RData")
depth.401TO500 <- readRDS("~/Notothenioids-Research/all_analysis_data_n_code/p9_csvAllLocations/SouthOrkneyIs/DDSOI1_pholomorpho+depthPlots/DDSOI.depth.401TO500_OUTPUTS.RData")
depth.501TO600 <- readRDS("~/Notothenioids-Research/all_analysis_data_n_code/p9_csvAllLocations/SouthOrkneyIs/DDSOI1_pholomorpho+depthPlots/DDSOI.depth.501TO600_OUTPUTS.RData")
depth.601TO700 <- readRDS("~/Notothenioids-Research/all_analysis_data_n_code/p9_csvAllLocations/SouthOrkneyIs/DDSOI1_pholomorpho+depthPlots/DDSOI.depth.601TO700_OUTPUTS.RData")
depth.701TO800 <- readRDS("~/Notothenioids-Research/all_analysis_data_n_code/p9_csvAllLocations/SouthOrkneyIs/DDSOI1_pholomorpho+depthPlots/DDSOI.depth.701TO800_OUTPUTS.RData")

depth.0TO200 <- readRDS("~/Notothenioids-Research/all_analysis_data_n_code/p9_csvAllLocations/SouthOrkneyIs/DDSOI1_pholomorpho+depthPlots/DDSOI.depth.0TO200_OUTPUTS.RData")
depth.201TO400 <- readRDS("~/Notothenioids-Research/all_analysis_data_n_code/p9_csvAllLocations/SouthOrkneyIs/DDSOI1_pholomorpho+depthPlots/DDSOI.depth.201TO400_OUTPUTS.RData")
depth.401TO600 <- readRDS("~/Notothenioids-Research/all_analysis_data_n_code/p9_csvAllLocations/SouthOrkneyIs/DDSOI1_pholomorpho+depthPlots/DDSOI.depth.401TO600_OUTPUTS.RData")
depth.601TO800 <- readRDS("~/Notothenioids-Research/all_analysis_data_n_code/p9_csvAllLocations/SouthOrkneyIs/DDSOI1_pholomorpho+depthPlots/DDSOI.depth.601TO800_OUTPUTS.RData")
