#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# DDSOI7 = DDSOI7_speciesVsDepth+speciesVsLength
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
# inputs
depth.data <- read.csv("~/Notothenioids_research/repository/all_analysis_data_n_code/p9_csvAllLocations/SouthOrkneyIs/depth.data.South.Orkney.Is.csv") # depth data for fish
depth.data.filtered <- read.csv("~/Notothenioids_research/repository/all_analysis_data_n_code/p9_csvAllLocations/SouthOrkneyIs/DDSOI1_pholomorpho+depthPlots/DDSOI.depth.data.filtered_OUTPUTS.csv") # csv of depth.data.filtered data
merged_data <- read.csv("~/Notothenioids_research/repository/all_analysis_data_n_code/p9_csvAllLocations/SouthOrkneyIs/DDSOI6_bodyLengthVsComps/merged_data.csv") # csv of the fishbase length
...
## ----------outputs----------
# PDF
pdf(file= "DDSOI7.speciesVsDepth+speciesVsLength_OUTPUTS.pdf" )
ggplot(depth.data,aes(x= Depth,y=Taxon, fill = stat(x))) +
  geom_density_ridges_gradient(scale = 3, rel_min_height = 0.01) + 
  scale_fill_viridis_c(name = "Depth", option = "C") + 
  labs(title = "Species by Depth") + 
