#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# DDSOI1 = DDAP1_phylomorpho_of_all_data+depthDataSubsets+convexHullGraphs
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
depth.data <- read.csv("~/Notothenioids_research/repository/all_analysis_data_n_code/p9_csvAllLocations/SouthOrkneyIs/depth.data.South.Orkney.Is.csv") # depth data for Antarctic Peninsula fish
...
area.val1 <- c(a1[[2]],a2[[2]],a3[[2]],a4[[2]],a5[[2]],a7[[2]],a8[[2]])
dev.new()
...
write.csv(depth.data.filtered, "DDSOI.depth.data.filtered_OUTPUTS.csv")

### RData
saveRDS(object = list.of.depth.data.100s, file = "DDSOI.listOfDepthData100s_OUTPUTS.RData")
saveRDS(object = list.of.depth.data.200s, file = "DDSOI.listOfDepthData200s_OUTPUTS.RData")

saveRDS(object = depth.0TO100, file = "DDSOI.depth.0TO100_OUTPUTS.RData")
saveRDS(object = depth.101TO200, file = "DDSOI.depth.101TO200_OUTPUTS.RData")
saveRDS(object = depth.201TO300, file = "DDSOI.depth.201TO300_OUTPUTS.RData")
saveRDS(object = depth.301TO400, file = "DDSOI.depth.301TO400_OUTPUTS.RData")
saveRDS(object = depth.401TO500, file = "DDSOI.depth.401TO500_OUTPUTS.RData")
saveRDS(object = depth.501TO600, file = "DDSOI.depth.501TO600_OUTPUTS.RData")
saveRDS(object = depth.601TO700, file = "DDSOI.depth.601TO700_OUTPUTS.RData")
saveRDS(object = depth.701TO800, file = "DDSOI.depth.701TO800_OUTPUTS.RData")

saveRDS(object = depth.0TO200, file = "DDSOI.depth.0TO200_OUTPUTS.RData")
saveRDS(object = depth.201TO400, file = "DDSOI.depth.201TO400_OUTPUTS.RData")
saveRDS(object = depth.401TO600, file = "DDSOI.depth.401TO600_OUTPUTS.RData")
saveRDS(object = depth.601TO800, file = "DDSOI.depth.601TO800_OUTPUTS.RData")


### PDF
pdf(file= "DDSOI1.cHullAreas100s+cHullAreas100s_OUTPUTS.pdf")
