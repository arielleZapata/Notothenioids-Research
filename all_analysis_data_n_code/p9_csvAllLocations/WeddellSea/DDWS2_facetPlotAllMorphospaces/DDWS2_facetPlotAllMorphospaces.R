#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# DDWS2 = DDWS2_facetPlotAllMorphospaces
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
depth.201TO300 <- readRDS("~/Notothenioids-Research/all_analysis_data_n_code/p9_csvAllLocations/WeddellSea/DDWS1_pholomorpho+depthPlots/DDWS.depth.201TO300_OUTPUTS.RData")
...
depth.601TO700 <- readRDS("~/Notothenioids-Research/all_analysis_data_n_code/p9_csvAllLocations/WeddellSea/DDWS1_pholomorpho+depthPlots/DDWS.depth.601TO700_OUTPUTS.RData")
...
depth.800plus <- readRDS("~/Notothenioids-Research/all_analysis_data_n_code/p9_csvAllLocations/WeddellSea/DDWS1_pholomorpho+depthPlots/DDWS.depth.800plus_OUTPUTS.RData")
...
depth.201TO400 <- readRDS("~/Notothenioids-Research/all_analysis_data_n_code/p9_csvAllLocations/WeddellSea/DDWS1_pholomorpho+depthPlots/DDWS.depth.201TO400_OUTPUTS.RData")
...
depth.601TO800 <- readRDS("~/Notothenioids-Research/all_analysis_data_n_code/p9_csvAllLocations/WeddellSea/DDWS1_pholomorpho+depthPlots/DDWS.depth.601TO800_OUTPUTS.RData")
...
space3_list <-make.morpho.depth(PCA,depth.201TO300,new.tree,title="Depth: 201-300","Species")
...
space7_list <-make.morpho.depth(PCA,depth.601TO700,new.tree,title="Depth: 601-700","Species")
#space8_list <-make.morpho.depth(PCA,depth.701TO800,new.tree,title="Depth: 701-800")
space9_list <-make.morpho.depth(PCA,depth.800plus,new.tree,title="Depth: 800+","Species")
...
space10_list <-make.morpho.depth(PCA,depth.201TO400,new.tree,title="Depth: 201-400","Species")
#space11_list <-make.morpho.depth(PCA,depth.401TO600,new.tree,title="Depth: 401-600")
space12_list <-make.morpho.depth(PCA,depth.601TO800,new.tree,title="Depth: 601-800","Species")
space13_list <-make.morpho.depth(PCA,depth.800plus,new.tree,title="Depth: 800+","Species")
...
## ----------outputs----------
### PDF
pdf(file= "DDWS2.facetPhyloSpace100s+facetPhyloSpace200s_OUTPUTS.pdf")
grid.arrange(grobs = plots1, ncol = 2, respect = TRUE)
grid.arrange(grobs = plots2, ncol = 2)
dev.off() 
