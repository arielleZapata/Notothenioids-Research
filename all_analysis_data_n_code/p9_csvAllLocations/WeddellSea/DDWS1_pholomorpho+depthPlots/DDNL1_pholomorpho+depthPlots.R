...
depth.data <- read.csv("~/Notothenioids_research/repository/all_analysis_data_n_code/p9_csvAllLocations/WeddellSea/depth.data.New.Location.csv") # depth data for Antarctic Peninsula fish
