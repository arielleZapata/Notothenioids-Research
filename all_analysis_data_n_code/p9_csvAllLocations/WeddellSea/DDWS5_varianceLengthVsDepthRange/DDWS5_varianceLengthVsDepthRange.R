#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# DDWS5 = DDWS5_varianceLengthVsDepthRange
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

# inputs
source("~/Notothenioids-Research/all_analysis_data_n_code/p0_initial_files/noto_functions.R")
list.of.depth.data.100s <- readRDS("~/Notothenioids-Research/all_analysis_data_n_code/p9_csvAllLocations/WeddellSea/DDWS1_pholomorpho+depthPlots/DDWS.listOfDepthData100s_OUTPUTS.RData")
list.of.depth.data.200s <- readRDS("~/Notothenioids-Research/all_analysis_data_n_code/p9_csvAllLocations/WeddellSea/DDWS1_pholomorpho+depthPlots/DDWS.listOfDepthData200s_OUTPUTS.RData")
...
colnames(var.100s) <- list("201to300","601to700","800+")
var.100s <- t(var.100s)
var.100s <- data.frame(var.100s)
...
colnames(var.200s) <- list("201to400","601to800","800+")
var.200s <- t(var.200s)
var.200s <- data.frame(var.200s)
...
## Outputs
### PDF
pdf(file= "DDWS5.plot100svariance+plot200svariance_OUTPUTS.pdf")
ggplot(var.100s,aes(x = x,y = y))+ 
  geom_segment(aes(x=x, xend=x, y=0, yend=y))+ 
  geom_point(size=5, color="purple", fill=alpha("pink", 0.3), alpha=0.7, shape=21, stroke=2) 
