#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# DDEI2 = DDEI2_facetPlotAllMorphospaces
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
depth.0TO100 <- readRDS("~/Notothenioids_research/repository/all_analysis_data_n_code/p9_csvAllLocations/ElephantIsland/DDEI1_pholomorpho+depthPlots/DDEI.depth.0TO100_OUTPUTS.RData")
depth.101TO200 <- readRDS("~/Notothenioids_research/repository/all_analysis_data_n_code/p9_csvAllLocations/ElephantIsland/DDEI1_pholomorpho+depthPlots/DDEI.depth.101TO200_OUTPUTS.RData")
depth.201TO300 <- readRDS("~/Notothenioids_research/repository/all_analysis_data_n_code/p9_csvAllLocations/ElephantIsland/DDEI1_pholomorpho+depthPlots/DDEI.depth.201TO300_OUTPUTS.RData")
depth.301TO400 <- readRDS("~/Notothenioids_research/repository/all_analysis_data_n_code/p9_csvAllLocations/ElephantIsland/DDEI1_pholomorpho+depthPlots/DDEI.depth.301TO400_OUTPUTS.RData")
depth.401TO500 <- readRDS("~/Notothenioids_research/repository/all_analysis_data_n_code/p9_csvAllLocations/ElephantIsland/DDEI1_pholomorpho+depthPlots/DDEI.depth.401TO500_OUTPUTS.RData")
depth.501TO600 <- readRDS("~/Notothenioids_research/repository/all_analysis_data_n_code/p9_csvAllLocations/ElephantIsland/DDEI1_pholomorpho+depthPlots/DDEI.depth.501TO600_OUTPUTS.RData")
depth.601TO700 <- readRDS("~/Notothenioids_research/repository/all_analysis_data_n_code/p9_csvAllLocations/ElephantIsland/DDEI1_pholomorpho+depthPlots/DDEI.depth.601TO700_OUTPUTS.RData")
depth.701TO800 <- readRDS("~/Notothenioids_research/repository/all_analysis_data_n_code/p9_csvAllLocations/ElephantIsland/DDEI1_pholomorpho+depthPlots/DDEI.depth.701TO800_OUTPUTS.RData")

depth.0TO200 <- readRDS("~/Notothenioids_research/repository/all_analysis_data_n_code/p9_csvAllLocations/ElephantIsland/DDEI1_pholomorpho+depthPlots/DDEI.depth.0TO200_OUTPUTS.RData")
depth.201TO400 <- readRDS("~/Notothenioids_research/repository/all_analysis_data_n_code/p9_csvAllLocations/ElephantIsland/DDEI1_pholomorpho+depthPlots/DDEI.depth.201TO400_OUTPUTS.RData")
depth.401TO600 <- readRDS("~/Notothenioids_research/repository/all_analysis_data_n_code/p9_csvAllLocations/ElephantIsland/DDEI1_pholomorpho+depthPlots/DDEI.depth.401TO600_OUTPUTS.RData")
depth.601TO800 <- readRDS("~/Notothenioids_research/repository/all_analysis_data_n_code/p9_csvAllLocations/ElephantIsland/DDEI1_pholomorpho+depthPlots/DDEI.depth.601TO800_OUTPUTS.RData")
...
## ----------outputs----------
### PDF
pdf(file= "DDEI2.facetPhyloSpace100s+facetPhyloSpace200s_OUTPUTS.pdf")
grid.arrange(grobs = plots1, ncol = 2, respect = TRUE)
grid.arrange(grobs = plots2, ncol = 2)
dev.off() 
