...
depth.data <- read.csv("~/Notothenioids-Research/all_analysis_data_n_code/p9_csvAllLocations/ElephantIsland/depth.data.Elephant.Island.csv") # depth data for Antarctic Peninsula fish
