#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# DDEI1 = DDEI1_phylomorpho_of_all_data+depthDataSubsets+convexHullGraphs
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
depth.data <- read.csv("~/Notothenioids_research/repository/all_analysis_data_n_code/p9_csvAllLocations/ElephantIsland/depth.data.Elephant.Island.csv") # depth data for Antarctic Peninsula fish
...
list.of.depth.data.100s <- list(depth.0TO100,depth.101TO200,depth.201TO300,depth.301TO400)
list.of.depth.data.200s <- list(depth.0TO200,depth.201TO400)
...
write.csv(depth.data.filtered, "DDEI.depth.data.filtered_OUTPUTS.csv")

### RData
saveRDS(object = list.of.depth.data.100s, file = "DDEI.listOfDepthData100s_OUTPUTS.RData")
saveRDS(object = list.of.depth.data.200s, file = "DDEI.listOfDepthData200s_OUTPUTS.RData")

saveRDS(object = depth.0TO100, file = "DDEI.depth.0TO100_OUTPUTS.RData")
saveRDS(object = depth.101TO200, file = "DDEI.depth.101TO200_OUTPUTS.RData")
saveRDS(object = depth.201TO300, file = "DDEI.depth.201TO300_OUTPUTS.RData")
saveRDS(object = depth.301TO400, file = "DDEI.depth.301TO400_OUTPUTS.RData")
saveRDS(object = depth.401TO500, file = "DDEI.depth.401TO500_OUTPUTS.RData")
saveRDS(object = depth.501TO600, file = "DDEI.depth.501TO600_OUTPUTS.RData")
saveRDS(object = depth.601TO700, file = "DDEI.depth.601TO700_OUTPUTS.RData")
saveRDS(object = depth.701TO800, file = "DDEI.depth.701TO800_OUTPUTS.RData")

saveRDS(object = depth.0TO200, file = "DDEI.depth.0TO200_OUTPUTS.RData")
saveRDS(object = depth.201TO400, file = "DDEI.depth.201TO400_OUTPUTS.RData")
saveRDS(object = depth.401TO600, file = "DDEI.depth.401TO600_OUTPUTS.RData")
saveRDS(object = depth.601TO800, file = "DDEI.depth.601TO800_OUTPUTS.RData") 

### PDF
pdf(file= "DDEP1.cHullAreas100s+cHullAreas200s_OUTPUTS.pdf")
