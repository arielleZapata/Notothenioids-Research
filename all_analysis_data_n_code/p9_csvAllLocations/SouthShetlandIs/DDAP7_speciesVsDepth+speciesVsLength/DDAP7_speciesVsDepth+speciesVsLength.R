#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# DDAP7 = DDAP7_speciesVsDepth+speciesVsLength
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
depth.data.filtered <- read.csv("~/Notothenioids_research/repository/all_analysis_data_n_code/p9_csvAllLocations/SouthShetlandIs/DDAP1_pholomorpho+depthPlots/DDAP.depth.data.filtered_OUTPUTS.csv") # csv of depth.data.filtered data
merged_data.revLog <- read.csv("~/Notothenioids_research/repository/all_analysis_data_n_code/p9_csvAllLocations/SouthShetlandIs/DDAP6_bodyLengthVsComps/merged_data.revLog.csv") # csv of the fishbase length
