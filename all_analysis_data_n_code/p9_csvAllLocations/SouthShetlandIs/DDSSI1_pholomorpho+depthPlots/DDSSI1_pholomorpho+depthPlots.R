#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# DDSSI1 = DDSSI1_phylomorpho_of_all_data+depthDataSubsets+convexHullGraphs
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
area.val1 <- c(a1[[2]],a2[[2]],a3[[2]],a4[[2]],a5[[2]])
dev.new()
...
write.csv(depth.data.filtered, "DDSSI1.depth.data.filtered_OUTPUTS.csv")

### RData
saveRDS(object = list.of.depth.data.100s, file = "DDSSI.listOfDepthData100s_OUTPUTS.RData")
saveRDS(object = list.of.depth.data.200s, file = "DDSSI.listOfDepthData200s_OUTPUTS.RData")

saveRDS(object = depth.0TO100, file = "DDSSI.depth.0TO100_OUTPUTS.RData")
saveRDS(object = depth.101TO200, file = "DDSSI.depth.101TO200_OUTPUTS.RData")
...
### PDF
pdf(file= "DDSSI1.cHullAreas100s+cHullAreas100s_OUTPUTS.pdf")
