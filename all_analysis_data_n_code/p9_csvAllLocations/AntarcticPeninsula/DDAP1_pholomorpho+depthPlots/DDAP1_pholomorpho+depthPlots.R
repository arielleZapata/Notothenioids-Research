#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# DDAP1 = DDAP1_phylomorpho_of_all_data+depthDataSubsets+convexHullGraphs
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
depth.data <- read.csv("~/Notothenioids_research/repository/all_analysis_data_n_code/p9_csvAllLocations/AntarcticPeninsula/depth.data.Antarctic.Peninsula.csv") # depth data for Antarctic Peninsula fish
...
write.csv(depth.data.filtered, "DDAP.depth.data.filtered_OUTPUTS.csv")

### RData
saveRDS(object = list.of.depth.data.100s, file = "DDAP.listOfDepthData100s_OUTPUTS.RData")
saveRDS(object = list.of.depth.data.200s, file = "DDAP.listOfDepthData200s_OUTPUTS.RData")

saveRDS(object = depth.0TO100, file = "DDAP.depth.0TO100_OUTPUTS.RData")
saveRDS(object = depth.101TO200, file = "DDAP.depth.101TO200_OUTPUTS.RData")
saveRDS(object = depth.201TO300, file = "DDAP.depth.201TO300_OUTPUTS.RData")
saveRDS(object = depth.301TO400, file = "DDAP.depth.301TO400_OUTPUTS.RData")
saveRDS(object = depth.401TO500, file = "DDAP.depth.401TO500_OUTPUTS.RData")
saveRDS(object = depth.501TO600, file = "DDAP.depth.501TO600_OUTPUTS.RData")
saveRDS(object = depth.601TO700, file = "DDAP.depth.601TO700_OUTPUTS.RData")
saveRDS(object = depth.701TO800, file = "DDAP.depth.701TO800_OUTPUTS.RData")

saveRDS(object = depth.0TO200, file = "DDAP.depth.0TO200_OUTPUTS.RData")
saveRDS(object = depth.201TO400, file = "DDAP.depth.201TO400_OUTPUTS.RData")
saveRDS(object = depth.401TO600, file = "DDAP.depth.401TO600_OUTPUTS.RData")
saveRDS(object = depth.601TO800, file = "DDAP.depth.601TO800_OUTPUTS.RData")
