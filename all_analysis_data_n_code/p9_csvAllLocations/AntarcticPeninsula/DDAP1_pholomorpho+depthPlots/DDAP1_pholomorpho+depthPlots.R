...
depth.data <- read.csv("~/Notothenioids-Research/all_analysis_data_n_code/p9_csvAllLocations/AntarcticPeninsula/depth.data.Antarctic.Peninsula.csv") # depth data for Antarctic Peninsula fish
