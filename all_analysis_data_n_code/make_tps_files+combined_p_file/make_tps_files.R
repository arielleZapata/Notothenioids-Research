...
setwd("~/Notothenioids_research/repository/all_analysis_data_n_code/make_tps_files+combined_p_file")
dir.create("tps_files")

# find consensus files folder "official_consensus_files" and set working directory
main_dir <- "~/Notothenioids_research/repository/all_analysis_data_n_code/make_tps_files+combined_p_file/official_consensus_files"
tps <- "~/Notothenioids_research/repository/all_analysis_data_n_code/make_tps_files+combined_p_file/tps_files"
setwd(main_dir)
...
setwd(tps)
sink("~/Notothenioids_research/repository/all_analysis_data_n_code/make_tps_files+combined_p_file/tps_files/all_tps_file.tps")
